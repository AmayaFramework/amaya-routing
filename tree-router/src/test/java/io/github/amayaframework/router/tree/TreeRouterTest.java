...
public final class TreeRouterTest {
    private static final PathParser PARSER = PathParsers.createDefault();
    private static final RouterFactory TREE_FACTORY = new TreeRouterFactory();
    ...
    public void testEmptyRouter() {
        var router = TREE_FACTORY.create(Map.of());
    ...
    public void testRootPath() {
        ...
        var router = TREE_FACTORY.create(paths);
